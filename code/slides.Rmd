...
The root issue is that R does not allow for "copying in place". We can
circumvent this by implementing a C++ function that modified the input
matrix directly. See files **scale.cpp** and **scale.geno.best.R** for
