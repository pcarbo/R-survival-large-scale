...
Automating the analysis on the RCC cluster
==========================================

Now that we have a better understanding of the memory requirements.

Memory allocation in R: take-home points
========================================

+ Important to run the code in a fresh R session to properly assess
memory needs.
...
+ Another effort is the purrr package, but has not yet extended
to matrices.

More advanced tools for memory profiling:
